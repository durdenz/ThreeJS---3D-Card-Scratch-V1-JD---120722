...
function init(){
    ...
    const cardMaterials = [
        new THREE.MeshStandardMaterial({ color: 0xdedede, reflectivity : 1, transparent:true, metalness : .25 }), //LeftSide
        new THREE.MeshStandardMaterial({ color: 0xdedede, reflectivity : 1, transparent:true, metalness : .25 }), //RightSide
        new THREE.MeshStandardMaterial({ color: 0xdedede, reflectivity : 1, transparent:true, metalness : .25 }), //Top
        new THREE.MeshStandardMaterial({ color: 0xdedede, reflectivity : 1, transparent:true, metalness : .25 }), //Bottom
